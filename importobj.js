...
/* Imports an object and converts to the engine format for webgl
   ...
   Assumes UV it top right corner, and adjusts for webgl*/
const fs = require('fs');
...
fs.readFile(process.argv[2], 'ascii', function(err,contents) {
  ...
  if(indeces.length < 1){
    console.log("No index info from obj file, aborting.");
    process.exit(0);
  }
